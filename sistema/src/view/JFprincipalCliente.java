 ...
 */
public class JFprincipalCliente extends javax.swing.JFrame {

    /**
     * Creates new form JFprincipalCliente
     */
    public JFprincipalCliente() {
        initComponents();
    ...
    public void pesquisaCliente() {
        ...
        cc.pesquisar(modelo, edtpesquisa.getText());
    ...
    public void preencheNosCampos() {
        ...
        lblcodigo.setText((String) tblcliente.getModel().getValueAt(selecionado, 0).toString());
        edtnome.setText((String) tblcliente.getModel().getValueAt(selecionado, 1).toString());
        edtcpf.setText((String) tblcliente.getModel().getValueAt(selecionado, 2).toString());
        edttelefone.setText((String) tblcliente.getModel().getValueAt(selecionado, 3).toString());
    }
    ...
    private boolean verificaVazio() {
        if (edtnome.getText().trim().equals("") || edtcpf.getText().trim().equals("") || edttelefone.getText().trim().equals("")) {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Controle de Clientes");
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGap(24, 24, 24)
                                    .addComponent(edtcpf, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup()
                                    .addGap(69, 69, 69)
                                    .addComponent(jLabel6)
                                    .addGap(18, 18, 18)
                                    .addComponent(edttelefone, javax.swing.GroupLayout.PREFERRED_SIZE, 258, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void insertCliente() {
        ...
        Registro.add(edtcpf.getText());
        Registro.add(edttelefone.getText());
        CtrlCliente cf = new CtrlCliente();
        cf.salvar(Registro);
        listarCliente();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFprincipalCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFprincipalCliente().setVisible(true);
            }
        });
    }
